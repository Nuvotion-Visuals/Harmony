import { bookmarks, config, HOME_PAGE } from "components/apps/Lexi.studio/config";
import { Arrow, Refresh, Stop } from "components/apps/Lexi.studio/NavigationIcons";
import StyledBrowser from "components/apps/Lexi.studio/StyledBrowser";
