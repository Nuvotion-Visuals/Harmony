...
const Page = ({ posts }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  ...
  return (<S.App src='https://framework.lexi.studio/admin/content-manager/collectionType/api::entity.entity?page=1&pageSize=100&sort=updatedAt:ASC' allow='camera;microphone' allowFullScreen></S.App>)
}
